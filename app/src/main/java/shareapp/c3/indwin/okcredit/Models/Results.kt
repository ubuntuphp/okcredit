...
data class Results (
    ...
    @SerializedName("des_facet") val des_facet : List<String> = ArrayList<String>(),
    @SerializedName("org_facet") val org_facet : List<String> = ArrayList<String>(),
    @SerializedName("per_facet") val per_facet : List<String> = ArrayList<String>(),
    @SerializedName("geo_facet") val geo_facet : List<String> = ArrayList<String>(),
